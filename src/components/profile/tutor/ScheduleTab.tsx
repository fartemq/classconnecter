...
import { Plus, Trash2, Clock, Eye, Calendar } from "lucide-react";
...
export const ScheduleTab = () => {
  ...
  const generatePreview = async () => {
    ...
    try {
      ...
      const targetDay = newSlot.day_of_week === 7 ? 0 : newSlot.day_of_week;
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="create" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="create">Создание расписания</TabsTrigger>
          <TabsTrigger value="view">Просмотр календаря</TabsTrigger>
        </TabsList>
        
        <TabsContent value="create" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Добавить временные слоты</CardTitle>
        ...
        <TabsContent value="view" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Просматривайте свои доступные слоты и забронированные занятия
              </p>
            </CardHeader>
            <CardContent>
              {user?.id && (
